...
urlpatterns = oauth2_urlpatterns + [
    ...
    re_path(fr'api/create_course_content_cms/<str:org>/{settings.COURSE_KEY_PATTERN}?$', contentstore_views.create_course_content_cms, name='create_course_content_cms'),
