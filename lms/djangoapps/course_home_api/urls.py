...
from lms.djangoapps.course_home_api.progress.views import ProgressTabView,AllEnrollmentProgressView
...
urlpatterns += [
    ...
    re_path(
        fr'progress/all_course',
        AllEnrollmentProgressView.as_view(),
